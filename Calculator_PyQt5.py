...
class MainWindow(qtw.QWidget):
    ...
    def keypad(self):
        ...
        btn_result = qtw.QPushButton('ВВОД', clicked=self._func_result)
        btn_clear = qtw.QPushButton('СБРОС', clicked=self._clear_calc)
        btn_9 = qtw.QPushButton('9', clicked=lambda: self._num_press('9'))
        btn_8 = qtw.QPushButton('8', clicked=lambda: self._num_press('8'))
        btn_7 = qtw.QPushButton('7', clicked=lambda: self._num_press('7'))
        btn_6 = qtw.QPushButton('6', clicked=lambda: self._num_press('6'))
        btn_5 = qtw.QPushButton('5', clicked=lambda: self._num_press('5'))
        btn_4 = qtw.QPushButton('4', clicked=lambda: self._num_press('4'))
        btn_3 = qtw.QPushButton('3', clicked=lambda: self._num_press('3'))
        btn_2 = qtw.QPushButton('2', clicked=lambda: self._num_press('2'))
        btn_1 = qtw.QPushButton('1', clicked=lambda: self._num_press('1'))
        btn_0 = qtw.QPushButton('0', clicked=lambda: self._num_press('0'))
        btn_plus = qtw.QPushButton('+', clicked=lambda: self._func_press('+'))
        btn_mins = qtw.QPushButton('-', clicked=lambda: self._func_press('-'))
        btn_mult = qtw.QPushButton('*', clicked=lambda: self._func_press('*'))
        btn_divd = qtw.QPushButton('÷', clicked=lambda: self._func_press('/'))
    ...
    def _num_press(self, key_number):
